...
- (void)messageInputToolbar:(ATLMessageInputToolbar *)messageInputToolbar didTapLeftAccessoryButton:(UIButton *)leftAccessoryButton
{
    ...
    UIActionSheet *actionSheet = [[UIActionSheet alloc] initWithTitle:nil
                                               ...
                                               destructiveButtonTitle:nil
                                                    otherButtonTitles:ATLLocalizedString(@"atl.conversation.toolbar.actionsheet.takephoto.key", @"Take Photo/Video", nil), ATLLocalizedString(@"atl.conversation.toolbar.actionsheet.library.key", @"Photo/Video Library", nil), nil];
...
{
    NSString *const UNKNOWN_USER = @"Unknown User";
    NSString *participantName;
    ...
    else if (message.sender.userID)
    {
        ...
        participantName = participant.fullName ?: UNKNOWN_USER;
    }
    else {
        participantName = UNKNOWN_USER;
    }
