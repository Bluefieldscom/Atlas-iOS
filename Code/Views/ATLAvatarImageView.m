...
{
    //set image or initials initialls
    [self populateAvatarImageOrInitialsForAvatarItem:avatarItem];
    
    //go grab image from url
    if ([avatarItem avatarImageURL]) {
        [self fetchAvatarImageFromURLWithAvatarItem:avatarItem];
    }
...
-(void)populateAvatarImageOrInitialsForAvatarItem:(id<ATLAvatarItem>)avatarItem
{
